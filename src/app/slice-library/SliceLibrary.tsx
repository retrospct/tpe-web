...
import { ApiDocument, Extensions, LinkResolver, RenderContext } from '@prismicio/api-renderer/lib/models'
        ...
        return (
          <div className="py-20" id={key} key={key}>
            <div className="mb-5 border-b border-gray-200 pb-5">
              ...
              <p className="mt-2 max-w-4xl text-sm text-gray-500">{variation.name}</p>
            </div>
            {variationFragment}
          </div>
        )
