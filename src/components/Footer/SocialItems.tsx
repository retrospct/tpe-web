            ...
            (item) =>
              isFilled.link(item.link) && (
                <PrismicNextLink
                  ...
                  field={item.link}
                  className="font-medium text-primary underline-offset-8 transition-all duration-300 hover:scale-105 hover:text-accent-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2"
                >
