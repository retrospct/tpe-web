      ...
      <li key={`list-item-${title}`}>
        <NavigationMenuLink asChild>
          ...
          <Link ref={ref} href={href || '/'} passHref {...props}>
            <div
              className={cn(
                'group/item relative block cursor-pointer select-none space-y-1 py-3 text-center leading-none outline-hidden focus:bg-accent/50 focus:text-accent-foreground disabled:opacity-5',
                className
              )}
            >
    ...
    return (
      <li key={`list-item-sheet-${title}`}>
        ...
        <Link ref={ref} href={href || '/'} passHref {...props}>
          <div
            className={cn(
              'block cursor-pointer select-none space-y-1 px-2 py-3 leading-none outline-hidden focus:bg-accent/50 focus:text-accent-foreground disabled:opacity-5',
              className
            )}
          >
            {/* <div className="flex items-center justify-between gap-6"> */}
