...
- Name: Contact Form Submissions >> should submit contact form on /contact page
- Location: /app/e2e/contact-form.spec.ts:44:7

# Error details

```
Error: page.goto: Protocol error (Page.navigate): Invalid url: "/contact"
Call log:
  - navigating to "/contact", waiting until "load"

    at /app/e2e/contact-form.spec.ts:45:16
```
